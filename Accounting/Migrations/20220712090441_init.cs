        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Persentage = table.Column<double>(type: "float", nullable: true),
                    Persentage2 = table.Column<double>(type: "float", nullable: true),
                    Type = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Formula = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Minimum = table.Column<double>(type: "float", nullable: true),
                    Formula2 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PositionName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecieverCompanyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transactions_Companies_RecieverCompanyId",
                        column: x => x.RecieverCompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Companies_SenderCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RecieverCompanyId",
                table: "Transactions",
                column: "RecieverCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderCompanyId",
                table: "Transactions",
